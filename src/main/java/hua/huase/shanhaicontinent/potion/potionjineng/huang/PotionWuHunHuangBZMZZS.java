package hua.huase.shanhaicontinent.potion.potionjineng.huang;
...
public class PotionWuHunHuangBZMZZS extends Potion
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ExampleMod.MODID + ":textures/potion/wuhunhuang/wuhunhuangbzmzzs.png");

    public PotionWuHunHuangBZMZZS()
    {
        super(false, 0x00ff00);
        this.setRegistryName(ExampleMod.MODID + ":wuhunhuangbzmzzs");
        this.setPotionName("effect." + ExampleMod.MODID + ".wuhunhuangbzmzzs");
    ...
    public void applyAttributesModifiersToEntity(EntityLivingBase entityLivingBaseIn, AbstractAttributeMap attributeMapIn, int amplifier)
    {
        ...
        capability.addWugong(6666f);
        capability.addWufang(6666f);
        capability.addBaojishanghai(66f);
        capability.addBaojilv(66f);
        capability.addShengminghuifu(66f);
        capability.addXixue(66f);
