...
public class PotionWuHunHtcLTLC extends Potion
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ExampleMod.MODID + ":textures/potion/wuhunhaotianchui/wuhunhtcltlc.png");

    public PotionWuHunHtcLTLC()
    {
        super(false, 0x00ff00);
        this.setRegistryName(ExampleMod.MODID + ":potion.wuhunhtcltlc");
        this.setPotionName("effect." + ExampleMod.MODID + ".potion.wuhunhtcltlc");
