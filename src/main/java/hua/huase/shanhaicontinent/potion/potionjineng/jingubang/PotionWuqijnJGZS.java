...
public class PotionWuqijnJGZS extends Potion
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ExampleMod.MODID + ":textures/potion/wuqijnjgzs.png");

    public PotionWuqijnJGZS()
    {
        super(false, 0xffffff);
        this.setRegistryName(ExampleMod.MODID + ":wuqijnjgzs");
        this.setPotionName("effect." + ExampleMod.MODID + ".wuqijnjgzs");
    ...
    public void applyAttributesModifiersToEntity(EntityLivingBase entityLivingBaseIn, AbstractAttributeMap attributeMapIn, int amplifier)
    {
        ...
        capability.addWugong(3000f);
        capability.addBaojishanghai(50f);
        capability.addBaojilv(20f);
