...
import hua.huase.shanhaicontinent.item.armor.ItemBuTaoArmor;
...
import hua.huase.shanhaicontinent.item.gui.ItemWanFaJieShao;
import hua.huase.shanhaicontinent.item.jineng.WuHunHaotianchui;
import hua.huase.shanhaicontinent.item.jineng.WuHunHuang;
import hua.huase.shanhaicontinent.item.jineng.WuHunJingubang;
import hua.huase.shanhaicontinent.item.jineng.haotianchui.*;
...
//public static final OreRuby ORE_RUBY = new OreRuby();
    ...
    public static Item wanfajieshao ;
    public static Item danfangjiuhua ;
    public static Item hunye ;
    public static Item danyao ;
//    public static Item danyaojiuhua ;

    public static ItemBuTaoArmor head ;
    public static ItemBuTaoArmor chest ;
    public static ItemBuTaoArmor feet ;
    public static ItemBuTaoArmor legs ;
    public static Wuqijingubang wuqijingubang ;
    ...
    public static void handleItem(RegistryEvent.Register<Item> e){
        ...
        wuqijingubang = new Wuqijingubang("wuqijingubang", TabExample.TAB2);
        ...
        new WuqiHaoTianChui("wuqihaotianchui", TabExample.TAB2);
        new WuqijnHtcHTZ("wuqijnhtchtz", TabExample.TAB2);
        ...
        new WuHunHaotianchui("haotianchui",TabExample.TAB2);
        ...
        new ItemWanFaJieShao("wanfajieshao", TabExample.TAB1);
        ...
        head = new ItemBuTaoArmor("head", TabExample.TAB1, EntityEquipmentSlot.HEAD);
        chest= new ItemBuTaoArmor("chest", TabExample.TAB1, EntityEquipmentSlot.CHEST);
        feet = new ItemBuTaoArmor("feet", TabExample.TAB1, EntityEquipmentSlot.FEET);
        legs = new ItemBuTaoArmor("legs", TabExample.TAB1, EntityEquipmentSlot.LEGS);
        ...
        e.getRegistry().register(feet);
        e.getRegistry().register(legs);
        ...
        e.getRegistry().register(wanfajieshao);
    ...
    public static void onModelreg(ModelRegistryEvent event){
        ...
        for (int i = 0; i < 16; i++) {
            ModelLoader.setCustomModelResourceLocation(
                    head,
                    i,
                    new ModelResourceLocation(new ResourceLocation(head.getRegistryName().toString()+"_grade"+i),"inventory")
            );
            ModelLoader.setCustomModelResourceLocation(
                    chest,
                    i,
                    new ModelResourceLocation(new ResourceLocation(chest.getRegistryName().toString()+"_grade"+i),"inventory")
            );
            ModelLoader.setCustomModelResourceLocation(
                    legs,
                    i,
                    new ModelResourceLocation(new ResourceLocation(legs.getRegistryName().toString()+"_grade"+i),"inventory")
            );
            ModelLoader.setCustomModelResourceLocation(
                    feet,
                    i,
                    new ModelResourceLocation(new ResourceLocation(feet.getRegistryName().toString()+"_grade"+i),"inventory")
            );
