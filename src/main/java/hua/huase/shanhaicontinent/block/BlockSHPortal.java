...
//            ((EntityPlayerMP) playerIn).changeDimension(1218,new CommandTeleporter(playerIn.getPosition()));
        if(entityIn instanceof EntityPlayer){
            PlayerCapability capability = ((EntityPlayer)entityIn).getCapability(CapabilityRegistryHandler.PLYAER_CAPABILITY, null);
            float jingshenli = capability.getMaxjingshenli();
            switch (worldIn.provider.getDimension()) {
                case 1212:
                    if(jingshenli<100){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
//                        SendTitle.sendTitle((EntityPlayerMP)entityIn,new TextComponentTranslation("message.chuanyueweidu.fail" , 100),ACTIONBAR,RED);
                        return;
                    }
                    entityIn.changeDimension(1213,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1213:
                    if(jingshenli<400){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
//                        SendTitle.sendTitle((EntityPlayerMP)entityIn,new TextComponentTranslation("message.chuanyueweidu.fail" , 200),ACTIONBAR,RED);
                        return;
                    }
                    entityIn.changeDimension(1214,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1214:
                    if(jingshenli<1600){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
//                        SendTitle.sendTitle((EntityPlayerMP)entityIn,new TextComponentTranslation("message.chuanyueweidu.fail" , 400),ACTIONBAR,RED);
                        return;
                    }
                    entityIn.changeDimension(1215,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1215:
                    if(jingshenli<6400){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
//                        SendTitle.sendTitle((EntityPlayerMP)entityIn,new TextComponentTranslation("message.chuanyueweidu.fail" , 800),ACTIONBAR,RED);
                        return;
                    }
                    entityIn.changeDimension(1216,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1216:
                    if(jingshenli<12800){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
//                        SendTitle.sendTitle((EntityPlayerMP)entityIn,new TextComponentTranslation("message.chuanyueweidu.fail" , 1600),ACTIONBAR,RED);
                        return;
                    }
                    entityIn.changeDimension(1217,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1217:
                    if(jingshenli<30000){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
//                        SendTitle.sendTitle((EntityPlayerMP)entityIn,new TextComponentTranslation("message.chuanyueweidu.fail" , 3200),ACTIONBAR,RED);
                        return;
                    }
                    entityIn.changeDimension(1218,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1218:
                    if(jingshenli<0){
                        entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
...
//                        return;
//                    }
                    entityIn.changeDimension(1212,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                case 1:
//                末地
                    entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
                default:
                    entityIn.changeDimension(worldIn.provider.getDimension()+1,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                    break;
            }
...
//                地狱
            ...
            case 0:
//                主世界
                entityIn.changeDimension(dimensionTypeSH_ONE_ID,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
                break;
            case 1:
//                末地
                entityIn.changeDimension(0,new BlockSHPortal.CommandTeleporter(entityIn.getPosition()));
    ...
    public static class CommandTeleporter implements ITeleporter
    {
        ...
        {
            entity.moveToBlockPosAndAngles(targetPos.add(0,80,0), yaw, entity.rotationPitch);
        }
    }
