...
//        HanderAny.itemList.add(itemBlock);
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos, Block notUsed, BlockPos fromPos) {
        if(!(world.getBlockState(pos.down()).getBlock() instanceof SoulSoil)){
            ...
            for (EntityPlayer entityplayer : list)
            {
                if(entityplayer!=null){
                    ...
                    if(capability.getJingshenli()<capability.getMaxjingshenli()) {
                        ...
                        SendTitle.sendTitle((EntityPlayerMP)entityplayer,new TextComponentTranslation("message.addjingshenli.success", i),ACTIONBAR,YELLOW);
                    }
