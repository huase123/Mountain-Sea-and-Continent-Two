...
public interface ChangeCapability {
    ...
    public static void addHunhuan(PlayerCapability playerCapability, MonsterCapability danyaoItemCapability, EntityPlayer player){
        ...
        if(playerCapability!=null&&danyaoItemCapability!=null){
            playerCapability.setWugong(playerCapability.getWugong()+danyaoItemCapability.getWugong()/20);
...
//            playerCapability.setBaojilv(playerCapability.getBaojilv()+danyaoItemCapability.getBaojilv()/10);
            playerCapability.setZhenshang(playerCapability.getZhenshang()+danyaoItemCapability.getZhenshang()/20);
//            playerCapability.setXixue(playerCapability.getXixue()+danyaoItemCapability.getXixue()/10);
            playerCapability.setWufang(playerCapability.getWufang()+danyaoItemCapability.getWufang()/20);
            playerCapability.setMaxshengming(playerCapability.getMaxshengming()+danyaoItemCapability.getMaxshengming()/20);
            playerCapability.setShengminghuifu(playerCapability.getShengminghuifu()+danyaoItemCapability.getShengminghuifu()/20);
            playerCapability.setMinghzong(playerCapability.getMinghzong()+danyaoItemCapability.getMinghzong()/20);
            playerCapability.setShanbi(playerCapability.getShanbi()+danyaoItemCapability.getShanbi()/20);
//            playerCapability.setWuchuan(playerCapability.getWuchuan()+danyaoItemCapability.getWuchuan()/10);
            playerCapability.setKangbao(playerCapability.getKangbao()+danyaoItemCapability.getKangbao()/20);
