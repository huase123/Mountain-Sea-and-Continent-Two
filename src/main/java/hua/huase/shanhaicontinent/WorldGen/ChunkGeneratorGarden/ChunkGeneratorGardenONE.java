...
package hua.huase.shanhaicontinent.WorldGen.ChunkGeneratorGarden;

import hua.huase.shanhaicontinent.WorldGen.worldstructureal.JvXianGe;
...
public class ChunkGeneratorGardenONE implements IChunkGenerator  {
    ...
    private JvXianGe JvXianGe = new JvXianGe();
...
//    private WoodlandMansion woodlandMansionGenerator = new WoodlandMansion(this);
    ...
    public ChunkGeneratorGardenONE(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
...
//        this.heightMap = new double[825];
        ...
        {
            ChunkGeneratorSettings.Factory factory = ChunkGeneratorSettings.Factory.jsonToFactory(generatorOptions);
            factory.seaLevel=10;
...
//                                    if( this.world.getBiomeProvider().getBiome(new BlockPos(x*16,0,z*16)).equals(HanderBiome.biomeSHIce)){
//
//                                        primer.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, PACKED_ICE);
//                                    }else {
//
//                                        primer.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, this.oceanBlock);
//                                    }
...
//        allowedBiomes.add(biome);
        this.rand.setSeed((long)x * 341873128712L + (long)z * 132897987541L + this.world.provider.getDimension());
        ChunkPrimer chunkprimer = new ChunkPrimer();
        this.setBlocksInChunk(x, z, chunkprimer);
        this.biomesForGeneration = this.world.getBiomeProvider().getBiomes(this.biomesForGeneration, x * 16, z * 16, 16, 16);
        this.replaceBiomeBlocks(x, z, chunkprimer, this.biomesForGeneration);
        this.JvXianGe.generate(this.world, x, z, chunkprimer);
//        this.villageGenerator.generate(this.world, x, z, chunkprimer);
//        this.mapGenEndCityMy.generate(this.world, x, z, chunkprimer);
//        this.caveGenerator.generate(this.world, x, z, chunkprimer);
//        this.ravineGenerator.generate(this.world, x, z, chunkprimer);
//        this.caveGeneratorMy.generate(this.world, x, z, chunkprimer);
/*
...
//        flag = this.villageGenerator.generateStructure(this.world, this.rand, chunkpos);
        flag = this.JvXianGe.generateStructure(this.world, this.rand, chunkpos);
//        if (this.mapFeaturesEnabled)
//        {
//            if (this.settings.useMineShafts)
//            {
