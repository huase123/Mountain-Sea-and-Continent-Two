...
import static hua.huase.shanhaicontinent.WorldGen.HanderBiome.dimensionTypeSH_SEVEN;

public class WorldProviderSeven extends WorldProvider
{
    ...
    {
        return new ChunkGeneratorGardenONE(world, world.getSeed()+7, world.getWorldInfo().isMapFeaturesEnabled(), world.getWorldInfo().getGeneratorOptions());
