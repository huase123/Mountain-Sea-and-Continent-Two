...
import hua.huase.shanhaicontinent.WorldGen.BiomeProvider.BiomeProviderSIX;
...
import static hua.huase.shanhaicontinent.WorldGen.HanderBiome.dimensionTypeSH_SIX;


public  class WorldProviderSIX extends WorldProvider {
    ...
    public WorldProviderSIX() {
        this.doesWaterVaporize = false;
    }
    public void init()
    {
        this.hasSkyLight = true;
        this.biomeProvider = new BiomeProviderSIX(world);
    }
...
//        return super.createChunkGenerator();
        return new ChunkGeneratorGardenONE(world, world.getSeed()+6, world.getWorldInfo().isMapFeaturesEnabled(), world.getWorldInfo().getGeneratorOptions());
