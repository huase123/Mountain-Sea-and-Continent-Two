...
import hua.huase.shanhaicontinent.WorldGen.BiomeProvider.BiomeProviderTWO;
...
import static hua.huase.shanhaicontinent.WorldGen.HanderBiome.dimensionTypeSH_TWO;


public  class WorldProviderTWO extends WorldProvider {
    ...
    public WorldProviderTWO() {
        this.doesWaterVaporize = false;
    }
    public void init()
    {
        this.hasSkyLight = true;
        this.biomeProvider = new BiomeProviderTWO(world);
    }
...
//        return super.createChunkGenerator();
        return new ChunkGeneratorGardenONE(world, world.getSeed()+2, world.getWorldInfo().isMapFeaturesEnabled(), world.getWorldInfo().getGeneratorOptions());
