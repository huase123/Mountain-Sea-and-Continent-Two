...
import static hua.huase.shanhaicontinent.WorldGen.HanderBiome.dimensionTypeSH_ONE;


public  class WorldProviderONE extends WorldProvider {
...
//        return super.createChunkGenerator();
        return new ChunkGeneratorGardenONE(world, world.getSeed()+1, world.getWorldInfo().isMapFeaturesEnabled(), world.getWorldInfo().getGeneratorOptions());
