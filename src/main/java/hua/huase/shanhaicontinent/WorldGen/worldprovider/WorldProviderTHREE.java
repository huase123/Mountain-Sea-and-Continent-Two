...
import hua.huase.shanhaicontinent.WorldGen.BiomeProvider.BiomeProviderTHREE;
...
import static hua.huase.shanhaicontinent.WorldGen.HanderBiome.dimensionTypeSH_THREE;


public  class WorldProviderTHREE extends WorldProvider {
    ...
    public WorldProviderTHREE() {
        this.doesWaterVaporize = false;
    }
    public void init()
    {
        this.hasSkyLight = true;
        this.biomeProvider = new BiomeProviderTHREE(world);
    }
...
//        return super.createChunkGenerator();
        return new ChunkGeneratorGardenONE(world, world.getSeed()+3, world.getWorldInfo().isMapFeaturesEnabled(), world.getWorldInfo().getGeneratorOptions());
