...
//        BiomeDictionary.addTypes(biome, BiomeDictionary.Type.COLD);
    ...
    public static int dimensionTypeSH_SEVEN_ID = 1218;
    ...
    public static DimensionType dimensionTypeSH_SEVEN;
...
//        myDim = DimensionType.register("my_dimension", "_my_dim", dimID, MyWorldProvider.class, false);
        ...
        dimensionTypeSH_SEVEN = DimensionType.register("shanhaicontinent_"+dimensionTypeSH_SEVEN_ID, "_SH_"+dimensionTypeSH_SEVEN_ID, dimensionTypeSH_SEVEN_ID, WorldProviderSeven.class, false);
...
//        DimensionManager.registerDimension(dimID, myDim);
        ...
        DimensionManager.registerDimension(dimensionTypeSH_SEVEN_ID, dimensionTypeSH_SEVEN);
