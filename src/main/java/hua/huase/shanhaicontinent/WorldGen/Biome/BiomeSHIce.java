...
import hua.huase.shanhaicontinent.entity.seamentitymob.SeaMTianHu;
...
public class BiomeSHIce extends BiomeBase
{
    ...
    public BiomeSHIce(BiomeSHIce.Type type , String name)
    {
        ...
        spawnableCreatureList.add(new Biome.SpawnListEntry(SeaMTianHu.class, 10, 0, 1));
        spawnableMonsterList.add(new Biome.SpawnListEntry(SeaMTianHu.class, 10, 0, 1));
