...
import hua.huase.shanhaicontinent.entity.seamentitymob.SeaMLoong;
...
public class BiomeSHHills extends BiomeBase
{
    protected static final IBlockState SNOW_LAYER = Blocks.SNOW_LAYER.getDefaultState();
//    protected final BiomeSHHills.Type type;
    public BiomeSHHills(BiomeBase.Type type , String name)
    {
        ...
        spawnableCreatureList.add(new Biome.SpawnListEntry(SeaMLoong.class, 10, 0, 1));
        spawnableMonsterList.add(new Biome.SpawnListEntry(SeaMLoong.class, 10, 0, 1));
                ...
                else if (iblockstate2.getBlock() == Blocks.STONE)
                {
                    if (j == -1)
                    {
                        ...
                        if (j1 >= i - 1)
                        {
                            ...
                            if(j1>=14&&rand.nextInt(2)==0){

                                chunkPrimerIn.setBlockState(i1, j1+1, l, SNOW_LAYER);
                            }
