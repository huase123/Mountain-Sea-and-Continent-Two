...
import hua.huase.shanhaicontinent.entity.seamentitymob.SeaMHuoQiLin;
...
public class BiomeSHNether extends BiomeBase
{
    ...
    public BiomeSHNether(BiomeSHNether.Type type , String name)
    {
        ...
        spawnableCreatureList.add(new Biome.SpawnListEntry(SeaMHuoQiLin.class, 10, 0, 1));
        spawnableMonsterList.add(new Biome.SpawnListEntry(SeaMHuoQiLin.class, 10, 0, 1));

        this.setRegistryName(ExampleMod.MODID,name+"_"+type.name());
        HanderBiome.biomeslist.add(this);
        this.topBlock = NETHERRACK;
        this.fillerBlock = NETHER_BRICK;
        ...
        for (int j1 = 255; j1 >= 0; --j1)
        {
            ...
            else
            {
                ...
                else if (iblockstate2.getBlock() == Blocks.STONE)
                {
                    if (j == -1)
                    {
                        ...
                        else if (j1 < i - 7 - k)
                        {
                            iblockstate = AIR;
                            iblockstate1 = STONE;
                            chunkPrimerIn.setBlockState(i1, j1, l, SOUL_SAND);
                        }
                        else
                        {
                ...
                else if (j1>=8 && iblockstate2.getBlock() == Blocks.WATER)
                {
                    ...
                    chunkPrimerIn.setBlockState(i1, j1, l, OBSIDIAN);
                }
