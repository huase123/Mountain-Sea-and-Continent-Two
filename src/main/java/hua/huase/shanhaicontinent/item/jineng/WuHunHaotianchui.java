...
public class WuHunHaotianchui extends Item {


    public WuHunHaotianchui(String name, CreativeTabs Tabs) {
        super();
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            ...
            if(juexingWuHun(playerIn,"haotianchui")){
                item.setCount(0);
            }
        }
...
//        list.remove(list.size()-1);
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.wuhunguoshi.haotianchui.list0"));
    }
