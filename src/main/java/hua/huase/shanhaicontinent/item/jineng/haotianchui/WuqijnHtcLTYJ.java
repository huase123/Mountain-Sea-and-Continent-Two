...
public class WuqijnHtcLTYJ extends Item implements JinengMethond
{
    public WuqijnHtcLTYJ(String name, CreativeTabs Tabs)
    {
        super();
...
//        playerIn.setActiveHand(handIn);
        ...
        if(!worldIn.isRemote){
            ...
            EntityJinengHtcLTYJ jiNengThread = new EntityJinengHtcLTYJ(worldIn,playerIn);
