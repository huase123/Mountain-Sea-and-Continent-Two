...
public class WuqijnDZSY extends Item implements JinengMethond
{
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if(!worldIn.isRemote){
            playerIn.addPotionEffect(new PotionEffect(PotionRegistryHandler.Potion_Wuqijn_DZSY,1000,0,true,true));
            EntityJiNengDZSY entityJiNengDZSY = new EntityJiNengDZSY(worldIn,playerIn);
            worldIn.spawnEntity(entityJiNengDZSY);
...
//添加数据
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.jingubang.jineng.dzsy.list0"));
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.jingubang.jineng.dzsy.list1"));
