...
public class WuqijnHtcTDWJ extends Item implements JinengMethond
{
    public WuqijnHtcTDWJ(String name, CreativeTabs Tabs)
    {
        super();
...
//            playerIn.getCooldownTracker().setCooldown(this, (int) (400-Math.log10(heldItem.getTagCompound().getInteger("nianxian"))*10));
            playerIn.getCooldownTracker().setCooldown(this, (int) (200-Math.log10(heldItem.getTagCompound().getInteger("nianxian"))*16));
        }else {
            return ActionResult.newResult(EnumActionResult.SUCCESS, heldItem);
        }
//        playerIn.setActiveHand(handIn);
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.tdwj.list0"));
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.tdwj.list1"));
        if(itemstack.getTagCompound()!=null&&itemstack.getTagCompound().getInteger("nianxian")>0){
            ...
            list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.lingque.cd")
                    +""
                    + new BigDecimal(10-Math.log10(integer)*0.84).setScale(2, BigDecimal.ROUND_HALF_UP).floatValue()
                    +"s"
            );
        }
