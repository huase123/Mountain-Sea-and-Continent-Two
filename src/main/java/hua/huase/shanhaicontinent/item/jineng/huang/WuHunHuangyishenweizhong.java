...
public class WuHunHuangyishenweizhong extends Item implements JinengMethond
{
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.addhunji.list0"));
        ...
        if(itemstack.getTagCompound()!=null){
            ...
            while (!wuhunjineng.equals(new NBTTagCompound())){
                ...
                list.add(JinengMethond.getItemStackName(itemStack)+I18n.translateToLocalFormatted("hungu.nianxian",itemStack.getTagCompound().getInteger("nianxian")));
                ++b;
