...
public class WuqijnHtcHTJJ extends Item implements JinengMethond
{
    public WuqijnHtcHTJJ(String name, CreativeTabs Tabs)
    {
        super();
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if(heldItem.getTagCompound()!=null&&heldItem.getTagCompound().getInteger("nianxian")>0){
            playerIn.getCooldownTracker().setCooldown(this, (int) (600-Math.log10(heldItem.getTagCompound().getInteger("nianxian"))*50));
        }else {
            return ActionResult.newResult(EnumActionResult.SUCCESS, heldItem);
        }
//        playerIn.setActiveHand(handIn);
        ...
        if(!worldIn.isRemote){
            ...
            EntityJinengHtcHTJJ jiNengThread = new EntityJinengHtcHTJJ(worldIn,playerIn);
...
//添加数据
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.htjj.list0"));
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.htjj.list1"));
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.htjj.list2"));
        if(itemstack.getTagCompound()!=null&&itemstack.getTagCompound().getInteger("nianxian")>0){
            ...
            list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.lingque.cd")
                    +""
                    + new BigDecimal(30-Math.log10(integer)*2.5).setScale(2, BigDecimal.ROUND_HALF_UP).floatValue()
                    +"s"
            );
        }
