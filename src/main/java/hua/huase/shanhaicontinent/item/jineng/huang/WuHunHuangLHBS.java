...
public class WuHunHuangLHBS extends Item implements JinengMethond
{
    public WuHunHuangLHBS(String name, CreativeTabs Tabs)
    {
        super();
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if(heldItem.getTagCompound()!=null&&heldItem.getTagCompound().getInteger("nianxian")>0){
            playerIn.getCooldownTracker().setCooldown(this, (int) (8000-Math.log10(heldItem.getTagCompound().getInteger("nianxian"))*1000));
        }else {
            return ActionResult.newResult(EnumActionResult.SUCCESS, heldItem);
        }
...
//        playerIn.setActiveHand(handIn);
        ...
        if(!worldIn.isRemote){
            ...
            playerIn.addPotionEffect(new PotionEffect(PotionRegistryHandler.Potion_Huang_LHBS,2000,0,true,true));
...
//添加数据
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.wuhun.huang.lhbs.list0"));
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.wuhun.huang.lhbs.list1"));
        if(itemstack.getTagCompound()!=null&&itemstack.getTagCompound().getInteger("nianxian")>0){
            ...
            list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.lingque.cd")
                    +""
                    + new BigDecimal(400-Math.log10(integer)*50).setScale(2, BigDecimal.ROUND_HALF_UP).floatValue()
                    +"s"
            );
        }
