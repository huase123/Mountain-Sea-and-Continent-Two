...
public class WuqijnHtcHTHD extends Item implements JinengMethond
{
    public WuqijnHtcHTHD(String name, CreativeTabs Tabs)
    {
        super();
...
//        playerIn.setActiveHand(handIn);
        ...
        if(!worldIn.isRemote){
            ...
            playerIn.addPotionEffect(new PotionEffect(PotionRegistryHandler.Potion_Haotianchui_HTHD,200,0,true,true));
...
//添加数据
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.hthd.list0"));
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.haotianchui.jineng.hthd.list1"));
