...
public class Hunye extends Item {
...
//        return null;
        DanyaoItemCapabilityProvider danyaoItemCapabilityProvider = new DanyaoItemCapabilityProvider(1, stack.getMetadata());
    ...
    public Hunye(String name, CreativeTabs Tabs){
        super();
        setRegistryName(name);
        setUnlocalizedName(ExampleMod.MODID  +"."+  name);
        setCreativeTab(Tabs);
        setHasSubtypes(true);
        HanderAny.hunye= this;
        setMaxStackSize(64);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            ...
            if(capability.getJingyan()>=capability.getMaxjingyan()){
                SendTitle.sendTitle((EntityPlayerMP)playerIn,new TextComponentTranslation("message.use.fail"),ACTIONBAR,YELLOW);
            ...
            SendTitle.sendTitle((EntityPlayerMP)playerIn,new TextComponentTranslation("message.use.success" , danyaocapability1.getJingyan()),ACTIONBAR,YELLOW);
        }
    ...
    public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
        ...
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("hunye_list0"));
