...
//=====================
            ...
            if(entityIn  instanceof EntityOtherPlayerMP) {
                ...
                if(hunhuankaiguan1 !=0){
                    ...
                    Float aFloat = timedonghuamap.get(entityIn.getEntityId());
                    for (MonsterCapability monsterCapability1 : capability1.getMonsterCapabilityList()) {
                        ...
                        if(aFloat>=i1){
                            ...
                            GlStateManager.pushMatrix();
                            GlStateManager.translate((float) x, (float) y + 0.05f+(1f-(aFloat-i1)/(10f-i1))*2, (float) z);
                            GlStateManager.rotate(90, 1, 0, 0);
...
//                            GlStateManager.scale(0.3f+ i1 /10f, 0.3f+ i1 /10f, 0);
                    ...
                    timedonghuamap.put(entityIn.getEntityId(), aFloat<=10f?aFloat+0.01f:aFloat);
                }
            }
