...
public class RenderSeaMLuoLuoNiao extends RenderSeaMEntityMob<EntityLiving> {
	public RenderSeaMLuoLuoNiao(RenderManager manager, ModelBase modelBiped, String textureName) {
