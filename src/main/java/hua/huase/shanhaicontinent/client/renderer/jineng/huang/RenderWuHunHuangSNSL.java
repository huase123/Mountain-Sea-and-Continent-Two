...
public class RenderWuHunHuangSNSL extends Render<EntityWuHunHuangSNSL>
{
    public RenderWuHunHuangSNSL(RenderManager renderManagerIn)
    {
    ...
    @Nullable
    protected ResourceLocation getEntityTexture(EntityWuHunHuangSNSL entity)
    {
        return null;
    }
}
