...
public class RenderSeaMTianHu extends RenderSeaMEntityMob<EntityLiving> {
	public RenderSeaMTianHu(RenderManager manager, ModelBase modelBiped, String textureName) {
