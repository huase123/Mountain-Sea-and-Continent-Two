...
public class RenderSeaMXvanGui extends RenderSeaMEntityMob<EntityLiving> {
	public RenderSeaMXvanGui(RenderManager manager, ModelBase modelBiped, String textureName) {
