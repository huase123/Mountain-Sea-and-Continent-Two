...
public class SeaMXvanGui extends EntityMob implements SeaMEntityMobBase {



    public static final String ID = "SeaM_XvanGui";
//    生成的群系，PLAINS平原  SAVANNA 热带草原    SAVANNA_PLATEAU 热带高原  MUTATED_PLAINS向日葵平原
    public static final Biome[] BIOMES = new Biome[] {OCEAN,DEEP_OCEAN,FROZEN_OCEAN};
    ...
    public static final EntityEntry XvanGui =
            EntityEntryBuilder.create()
                    .entity(SeaMXvanGui.class)
                    .id(SeaMXvanGui.ID, EntityRegistryHandler.entityID++)
                    .name(ExampleMod.MODID + "." + SeaMXvanGui.ID)
                    .tracker(80, 3, true)
                    .egg(0xe52222, 0xd7ef39)
                    .spawn(EnumCreatureType.WATER_CREATURE, 5000, 4, 4, SeaMXvanGui.BIOMES)
                    .build();

    public SeaMXvanGui(World worldIn)
    {
        super(worldIn);
    ...
    private static final ResourceLocation LOOT_TABLE = LootTableList.register(
            new ResourceLocation(ExampleMod.MODID + ":entities/xvangui"));
...
//        return GUFENGXIAOWU_CHESTS;
    ...
    {
        this.wander = new EntityAIWander(this, 3.0D, 80);
        EntityAIMoveTowardsRestriction entityaimovetowardsrestriction = new EntityAIMoveTowardsRestriction(this, 3.0D);
//        this.tasks.addTask(0, new EntityAISwimming(this));//游泳
        this.tasks.addTask(1, new EntityAIAttackMelee(this, 0.1, false));//攻击
        this.tasks.addTask(2, new EntityAIWanderAvoidWater(this, 2.8));//闲逛
//        this.tasks.addTask(3, new AIChangeGrassToDirt(this));//脚下方块替换为草方块
        ...
        this.tasks.addTask(6, new EntityAILookIdle(this));//发呆
...
//用于servce与client相互同步参数
    private static final DataParameter<Byte> COLOR =
            EntityDataManager.createKey(SeaMXvanGui.class, DataSerializers.BYTE);
    private static final DataParameter<NBTTagCompound> LIVINGENTITYCAPABILITY =
            EntityDataManager.createKey(SeaMXvanGui.class, DataSerializers.COMPOUND_TAG);
