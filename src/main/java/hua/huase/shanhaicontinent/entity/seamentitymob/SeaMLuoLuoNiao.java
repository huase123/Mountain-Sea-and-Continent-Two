...
public class SeaMLuoLuoNiao extends EntityMob implements SeaMEntityMobBase {



    public static final String ID = "SeaM_LuoLuoNiao";
//    生成的群系，PLAINS平原  SAVANNA 热带草原    SAVANNA_PLATEAU 热带高原  MUTATED_PLAINS向日葵平原
    public static final Biome[] BIOMES = new Biome[] {PLAINS};
    ...
    public static final EntityEntry LuoLuoNiao =
            EntityEntryBuilder.create()
                    .entity(SeaMLuoLuoNiao.class)
                    .id(SeaMLuoLuoNiao.ID, EntityRegistryHandler.entityID++)
                    .name(ExampleMod.MODID + "." + SeaMLuoLuoNiao.ID)
                    .tracker(80, 3, true)
                    .egg(0xe52222, 0xd7ef39)
                    .spawn(EnumCreatureType.MONSTER, 200, 4, 4, SeaMLuoLuoNiao.BIOMES)
                    .build();

    public SeaMLuoLuoNiao(World worldIn)
    {
        super(worldIn);
    ...
    private static final ResourceLocation LOOT_TABLE = LootTableList.register(
            new ResourceLocation(ExampleMod.MODID + ":entities/luoluoniao"));
...
//用于servce与client相互同步参数
    private static final DataParameter<Byte> COLOR =
            EntityDataManager.createKey(SeaMLuoLuoNiao.class, DataSerializers.BYTE);
    private static final DataParameter<NBTTagCompound> LIVINGENTITYCAPABILITY =
            EntityDataManager.createKey(SeaMLuoLuoNiao.class, DataSerializers.COMPOUND_TAG);
