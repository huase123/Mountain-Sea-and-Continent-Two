    ...
    public void update() {
        ...
        if (canExtractInput) {
            if (this.compressorProgress % 80 == 0) {
                ...
                if (TileEntityFurnace.getItemBurnTime(this.SLOT1.extractItem(0, 1, true))>0||this.fuel!=0) {
                    boolean b = false;
